...
public class OI {
    ...
    public JoystickButton tarpButton;
    ...
    public OI() {
        ...
        tarpButton = new JoystickButton(leftJoystick, 2);
        tarpButton.whenPressed(new MoveTarp());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("Drive", new Drive());
        SmartDashboard.putData("Move Tarp", new MoveTarp());
