...
public class Robot extends IterativeRobot {
	...
	double driveOffset;
	public static int autoPos;
	
    AutonomousCG autonomousCommand;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        //Get the cameras and start the stream
        ...
        //Calibrate gyro so it's at zero
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        //Get a number from the dashboard to determine which auto code to run
        //0 = Left side
        //1 = Middle
        //2 = Right Side
    ...
    public void autonomousInit() {
    	...
    	autoPos = (int)SmartDashboard.getNumber("Auto Pos", 1);
